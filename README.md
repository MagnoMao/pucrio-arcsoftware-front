...
É possível adicionar um novo endereço que seria vinculado a um usuário, porém por causa de um problema utilizando o flask não consegui implementar essa parte a partir do front end, apenas a partir do back end com o swagger; Porém é possível adicionar atrvés do front usuários e livros para o back end.
